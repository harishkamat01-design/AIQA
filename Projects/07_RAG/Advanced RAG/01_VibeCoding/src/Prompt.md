...
Upgrades `VibeCoded_Advance_RAG_EXPLAIN`
...
UI uses a Atalssian.com inspired theme (blue) with a two-pane layout:
...
```bash
cd 07_RAG/Advanced RAG/01_VibeCoding
python3 -m venv .venv
...
If Required took the   `GROQ_API_KEY` from .env file
