...
| 3 | Test cases (~1,000) | CSV / XLSX (e.g., `testdata.csv`) | 1 |
...
First of all, you need to create a folder for 10 things. I will be putting the data there so that you can fetch it. Also, use the Jira MCP connection. I will be sharing with you my connection to fetch the Jira tickets. Also, I will give you a JQL. By using the JQL, you will be able to fetch all the Jiras. Also, we need to put them into RAG.
...
Embedder	- BGE-M3 (FlagEmbedding) — produces dense (1024d) + sparse
...
## 11. README.md File
create a readme.md file and provide each and every step in that. 

## 12. Plan.md file
Create prompt.md file also. 

## 13. Open the UI when it is ready, and we are going to test it. 
Create a UI with the color combination of https://claude.ai/new