...
export default function App() {
  ...
  const storageMode = status?.chroma?.mode || (chromaDown ? 'local-file' : 'chroma')
    ...
    <div className="app">
      ...
      {(chromaDown || groqMissing || error) && (
        <div className="alerts">
          {chromaDown && <div className="alert warn">ChromaDB not reachable at {status?.chroma?.url}. Using a local fallback store ({storageMode}) for ingestion and retrieval.</div>}
